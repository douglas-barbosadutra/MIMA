...
public class ManufacturingResourceIntTest {
    ...
    public void createManufacturing() throws Exception {
        ...
        ManufacturingDTO manufacturingDTO = manufacturingMapper.toDto(manufacturing);
        restManufacturingMockMvc.perform(post("/api/manufacturings")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(manufacturingDTO)))
    ...
    public void updateManufacturing() throws Exception {
        ...
        ManufacturingDTO manufacturingDTO = manufacturingMapper.toDto(updatedManufacturing);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(ManufacturingDTO.class);
        ManufacturingDTO manufacturingDTO1 = new ManufacturingDTO();
        manufacturingDTO1.setId(1L);
        ManufacturingDTO manufacturingDTO2 = new ManufacturingDTO();
        assertThat(manufacturingDTO1).isNotEqualTo(manufacturingDTO2);
        manufacturingDTO2.setId(manufacturingDTO1.getId());
        assertThat(manufacturingDTO1).isEqualTo(manufacturingDTO2);
        manufacturingDTO2.setId(2L);
        assertThat(manufacturingDTO1).isNotEqualTo(manufacturingDTO2);
        manufacturingDTO1.setId(null);
        assertThat(manufacturingDTO1).isNotEqualTo(manufacturingDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(manufacturingMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(manufacturingMapper.fromId(null)).isNull();
    }
}
