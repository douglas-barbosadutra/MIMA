...
public class InstructionConverter{
	...
	public static Instruction convertToIstruzione(InstructionDTO istruzionedto, int idTask) {
		return (new Instruction(istruzionedto.getNomeIstruzione(), istruzionedto.getDurata(), idTask, istruzionedto.getId()));
	}

	public static InstructionDTO convertToDto(Instruction istruzione) {
		return (new InstructionDTO(istruzione.getNome(), istruzione.getDurata(), istruzione.getId()));
	}
}
