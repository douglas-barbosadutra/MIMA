						...
						for(int i = 0; i < schedulingList.size(); i++)
						{
							...
							<tr>
								...
								<%if(mode.equals("delete")){
									...
									%><th><a style="text-decoration:none; text-align:center;" class="btn btn-primary" href="OperazioneSchedulazioneServlet?action=showOperazioni&idSchedulazione=<%=schedulingList.get(i).getId()%>&idMacchinario=<%=schedulingList.get(i).getIdMacchinario()%>">Gestisci</a></th><%
